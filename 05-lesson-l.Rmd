...
options = c("Iulia rosas carpit", "Rosae puellam delectant: ea laeta est", "Puella rosas in horto agit", "Iulia rosas ex impluvio sumit"),
type = "checkbox",
button_label = "Rectene dico?🤔",
right = "**Optime!😸**",
wrong = "**Minime😿**",
...
options = c("Aemilia laeta rosas sumit", "Aemilia cum liberis suis in impluvio est", "Iulia rosas ab Aemilia carpit", "Pueri Iuliam rident"),
type = "checkbox",
button_label = "Rectene dico?🤔",
right = "**Optime!😸**",
wrong = "**Minime😿**",
