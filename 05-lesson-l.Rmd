...
```{r}
check_question("-os, -a, -as, -os", right = "optime 👍 ", wrong = "cogitandum est 🤔", button_label = "Rectene dico?", placeholder = "-a, -as, -os, -os")
```
</br>
...
**5. Aemilia cum liber___ in horto est. Aemilia liber___ laudat. Iulius ab oppid___ venit. Iulia ex peristyl___ discedit et patrem salutat.**
```{r}
