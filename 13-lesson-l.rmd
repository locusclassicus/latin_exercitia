...
```{r}
check_question(answer= ("triginta, dies, tertio, die"), right = "ita😸", wrong = "correge😕", button_label = "rectene dico?", options = c("triginta, dies, tertio, die", "triginta, die, tertio, dies", "tertio, die, triginta, dies", "tertio, dies, triginta, die"), type = "radio")
```

</br>
**3.__ folia de arboribis cadunt; __ campi nova herba operiuntur; __ aer callidissimus est; __ nix cadit de caelo.**
```{r}
check_question (answer = "autumno, vere, aestate, hieme", right ="Ita est 🤩", wrong ="Non ita 😔", button_label = "rectene dico?", options = c("autumno, aestate, vere, hieme", "autumno, hieme, aestate, vere", "autumno, vere, aestate, hieme"), type = "checkbox")
```
...
```{r}
check_question(answer= ("28.12"), right = "ita😸", wrong = "correge😕", button_label = "rectene dico?", options = c("27.12", "28.12", "05.01", "26.12"), type = "radio")
```
...
```{r}
check_question(answer = ("faciem, facie, faciei, faciei"),right = "bene😸", wrong = "non ita😔", button_label = "rectene dico?", options = c("faciem, facie, faciei, faciei", "faciem, faciei, facie, faciei", "facie, faciei, faciei, faciem", "facie, faciem, faciei, faciei"), type = "radio")
```
