...
```{r}
check_question("laeta, cantat, laetus, pulsat", options=c("laeta, cantat, iratus, pulsat","laeta, cantat, laetus, pulsat","irata, plorat, laetus, pulsat","laeta, vocat, iratus, pulsat"),type="radio", button_label="Rectene dico?",right="Optime! 👍",wrong="Minime 😔")
```
...
```{r}
check_question("neque, hic, iam",options=c("neque, iam, cur","neque, hic, iam","neque, hic, cur","neque, iam, hic"),type="radio",button_label="Rectene dico?",right="Recte sane 🙂",wrong="Non ita 😿️")
```
...
```{r}
check_question("Quem, eum, Quam, eam",options=c("Quem, eum, Quam, eam","Quem, eum, Eam, quam","Quem, eam, Quam, eum","Quam, eum, Quem, eam"),type="radio",button_label="Rectene dico?",right="Probe👌",wrong="Non hercle vero!😕", random_answer_order = T)
```
